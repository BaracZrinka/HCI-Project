...
const ProfileFeed = () => <section className={styles.hottestSection}>
    <ProfilePost image={<PPost1 />} title="First topic" text={FirstText}/>
    <ProfilePost image={<PPost2 />} title="Second topic" text={SecondText}/>
    <ProfilePost image={<PPost3 />} title="Third topic" text={ThirdText}/>
</section> 
